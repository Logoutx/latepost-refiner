...
- Before handoff, run the deterministic audit when available (`audit_refined.mjs`): fix or surface leftover pure filler (嗯/呃, 对对对/是是是, 我我/就就) and over-long paragraphs. 啊/哦/欸 and 这个/那个 are soft candidates — inspect context, don't blanket-delete.
